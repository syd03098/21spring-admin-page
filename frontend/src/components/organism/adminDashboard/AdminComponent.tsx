...
import ShowDesktop from '@components/atom/Desktop';
import SideNavButton from '@components/organism/adminDashboard/SideNavButton';
import {
    StyledModalPosition,
    StyledModalContainer,
    StyledModalBackground,
} from '@components/organism/adminDashboard/AdminComponent.style';
import Schedules from '@components/organism/adminDashboard/Schedules';
import Persons from '@components/organism/adminDashboard/Persons';
import Reservations from '@components/organism/adminDashboard/Reservations';
import Movies from '@components/organism/adminDashboard/Movies';
import Members from '@components/organism/adminDashboard/Members';
import Seats from '@components/organism/adminDashboard/Seats';

const AdminComponent = (): JSX.Element => {
    const { ModalContainer, toggleTab, currentTab } = useAdmin();
