...
function CreateAdminContext(): AdminStoreContext {
...
export const AdminStoreContext = createContext<AdminStoreContext | null>(null);

export const AdminStoreProvider = ({ children }: { children: ReactNode }): JSX.Element => {
    return <AdminStoreContext.Provider value={CreateAdminContext()}>{children}</AdminStoreContext.Provider>;
};

export const useAdmin = (): AdminStoreContext => {
